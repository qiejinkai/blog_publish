...
<body>
	...
	<div class="ef-main">
		...
		<div class="ef-block">
			...
			<h1>
				<a href="/admin/content/banner/1">banner管理</a> <span
			...
			<p class="txt">${article.articleId == 0?'新建banner':'修改banner'}</p>
			...
			<div class="content">
				...
				<div class="container">
					...
					<form action="" method="post">
						...
						<input type="hidden" name="alias" value="banner" /> <input
							...
							<tbody>
								...
								<tr>
									<td><a class="ui-image" href="javascript:;"
										...
										style="width:940px; height: 265px;"> <input type="file"
