			...
			<div class="content">
				...
				<div class="container">
								...
								<c:forEach items="${pager.list }" var="article">
									<tr>
										...
										<td><a href="/admin/content/mood/${article.articleId}/set">编辑</a>
											...
											<a href="/admin/content/mood/${article.articleId}/hidden">${article.hidden == 0 ?'隐藏':'取消隐藏'}</a>
										</td>
									</tr>
								</c:forEach>
					...
					<div class="ui-bottombar">
						<a href="/admin/content/mood/0/set" class="ui-btn">+ 创建说说</a>
					</div>
