...
<body>
	...
	<div class="ef-main">
		...
		<div class="ef-block">
			...
			<h1>
				<a href="/admin/content/article/${article.group.groupId}/1">文章管理</a>
			...
			<p class="txt">${article.articleId == 0?'新建文章':'修改文章内容'}</p>
			...
			<div class="content">
				...
				<div class="container">
					...
					<form action="" method="post">
						...
						<input type="hidden" name="groupId" value="${article.group.groupId}" />
						<input type="hidden" name="alias" value="article" /> <input
