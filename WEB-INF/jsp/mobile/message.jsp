...
<meta name="description" content="小幸运-留言板" />
				...
				<div class="ds-login-buttons">
					<p>社交帐号登录:</p>
						...
						<div class="ds-social-links">
							<ul class="ds-service-list">
								<li>
									<a href="/qquser/login/?r=/message" rel="nofollow" class="ds-service-link ds-qq">QQ</a>
								</li>
								</ul>
						</div>
						<div class="ds-social-links">
							<ul class="ds-service-list">
								<li>
									<a href="/wbuser/login/?r=/message" rel="nofollow" class="ds-service-link ds-wb">微博</a>
								</li>
								</ul>
						</div>
				</div>
