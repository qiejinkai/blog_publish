        ...
        <div class="item_list">
            ...
            <div class="item_img">
                ...
                <div class="item_share">
                    ...
                    <a class="right r1" href='http://service.weibo.com/share/share.php?url=http%3A%2F%2Fqiejinkai.com%2Fproject%2F%3Fid%3D4&title=${article.title }&pics=${article.image }&source=bookmark&appkey=2992571369&ralateUid='></a>
                </div>
            </div>           
...
<script>
    ...
    $(function(){
    	...
    	function addArticle(article){
    		...
    		str+='<span class="sp6">'+article.group.name+'</span>';
    		...
    		str+='<div class="item_share">';
    		str+='<a class="click_btn" href="/article/detail/'+article.articleId+'">阅读全文</a>';
    		str+='</div>';
    		str+='</div>';
    		str+='</div>';
