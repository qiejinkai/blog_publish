		...
		<!-- message Begin -->
 			...
 			<div id="ds-reset">
				...
				<div class="ds-paginator">
					...
					<qjk:mpager url="/diary/detail/${article.articleId }/" value="messages"/>
				</div>
				...
				<div class="ds-login-buttons">
					<p>社交帐号登录:</p>
						...
						<div class="ds-social-links">
							<ul class="ds-service-list">
								<li>
									<a href="/qquser/login/?r=/diary/detail/${article.articleId }" rel="nofollow" class="ds-service-link ds-qq">QQ</a>
								</li>
								</ul>
						</div>
						<div class="ds-social-links">
				...
				<div class="ds-login-buttons">
					<p>当前登陆用户:<span style="color:red;cursor:pointer">${user.nick }</span></p>
						<div class="ds-social-links">
							<ul class="ds-service-list">
								<li>
									<a href="/logout/?r=/diary/detail/${article.articleId }" >退出</a>
								</li>
								</ul>
						</div>
